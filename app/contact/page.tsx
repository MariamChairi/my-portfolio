  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-8 justify-center mb-24">
        {/* LinkedIn */}
          <Link href="https://www.linkedin.com/in/mariam-chairi-8471a3389" className="group/link flex flex-col md:flex-row items-center gap-4 md:gap-6 p-3 md:p-4 bg-slate-900/30 rounded-3xl border border-slate-800/50 hover:bg-slate-800/50 flex-1 min-w-0">
        ...
        {/* GitHub */}
          <Link href="https://github.com/MariamChairi" className="group/link flex flex-col md:flex-row items-center gap-4 md:gap-6 p-3 md:p-4 bg-slate-900/30 rounded-3xl border border-slate-800/50 hover:bg-slate-800/50 flex-1 min-w-0">
            <div className="w-16 md:w-20 h-16 md:h-20 flex-shrink-0 bg-slate-950/50 rounded-3xl flex items-center justify-center border-2 border-slate-800/60 shadow-xl group-hover/link:border-blue-500/50">
              <svg className="w-8 md:w-10 h-8 md:h-10 text-slate-400 group-hover/link:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
