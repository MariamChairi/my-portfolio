    ...
    <div className="min-h-screen flex flex-col items-center justify-center text-center relative">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center mb-24">
          <Link href="/projects">
            <div className="btn-cd group font-mono text-xl px-6 md:px-16 py-6 md:py-10 shadow-2xl hover:shadow-3xl hover:scale-105 hover:-translate-y-3 bg-gradient-to-r from-primary to-accent text-primary-foreground rounded-3xl glass cursor-pointer transition-all duration-500">
              cd projects/
          ...
          <Link href="/skills">
            <div className="group font-mono text-xl px-6 md:px-16 py-6 md:py-10 border-2 border-primary shadow-2xl hover:shadow-3xl hover:scale-105 hover:-translate-y-3 rounded-3xl glass cursor-pointer transition-all duration-500 bg-transparent text-primary hover:bg-primary text-primary-foreground">
              ls skills/
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-24">
          ...
          <div className="group bg-card/85 backdrop-blur-xl rounded-3xl p-12 border border-border/50 glass">
            <div className="text-3xl sm:text-5xl md:text-6xl font-mono font-bold text-accent mb-6">Master</div>
          ...
          <div className="group bg-card/85 backdrop-blur-xl rounded-3xl p-12 border border-border/50 glass">
            <div className="text-3xl sm:text-5xl md:text-6xl font-mono font-bold text-secondary mb-6">10+</div>
